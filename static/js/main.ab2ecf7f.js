/*! For license information please see main.ab2ecf7f.js.LICENSE.txt */
...
`,Lr=Yt.p`
  ...
  color: ${Qt.colors.textSecondary};
  line-height: 1.6;
`,Ir=e=>{let{education:t}=e;return(0,Xt.jsx)(Er,{id:"education",children:(0,Xt.jsxs)(zr,{children:[(0,Xt.jsx)(sn,{level:2,size:"title1",gradient:!0,withAccent:!0,children:"Education"}),(0,Xt.jsx)(_r,{children:t.map(((e,t)=>(0,Xt.jsxs)(Pr,{children:[(0,Xt.jsx)(jr,{children:e.degree}),(0,Xt.jsx)(Tr,{children:e.field}),(0,Xt.jsx)(Ar,{children:e.institution}),(0,Xt.jsx)(Rr,{children:e.location}),(0,Xt.jsx)(Nr,{children:e.period}),(0,Xt.jsx)(Lr,{children:e.description})]},t)))})]})})},Or=Yt(tn)`
  background: linear-gradient(180deg, ${Qt.colors.backgroundAlt} 0%, ${Qt.colors.background} 100%);
  padding: ${Qt.spacing.xxl} 0;
`,Dr=Yt(rn)`
  max-width: 1200px;
...
`,Jr=Yt.div`
  ...
  &::before {
    ...
    right: 0;
    height: 3px;
    background: linear-gradient(90deg, ${Qt.colors.primary}, ${Qt.colors.aiAccent}, ${Qt.colors.primary});
    animation: ${qr} 3s ease-in-out infinite;
  }
  
  &:hover {
    animation: ${Qr} 0.3s ease-in-out;
  }
`,Zr=Yt.div`
  display: flex;
  align-items: center;
...
`,aa=Yt.div`
  animation: ${Gr} 0.8s ease-out 0.2s both;
`,ia=Yt.div`
  animation: ${Kr} 0.8s ease-out 0.4s both;
`,oa=Yt.h3`
  font-size: 1.4rem;
  color: ${Qt.colors.text};
  margin-bottom: ${Qt.spacing.lg};
...
`,ma=Yt.span`
  ...
  font-size: 1rem;
  line-height: 1.5;
`,ha=e=>{let{competencies:t,technicalSkills:n}=e;return(0,Xt.jsx)(Xr,{id:"product-manager-skills",children:(0,Xt.jsx)(rn,{children:(0,Xt.jsxs)(Jr,{children:[(0,Xt.jsxs)(Zr,{children:[(0,Xt.jsx)(ea,{children:"\ud83d\ude80"}),(0,Xt.jsxs)(ta,{children:[(0,Xt.jsx)(sn,{level:2,size:"title1",gradient:!0,withAccent:!0,children:"Product Manager Skills & Competencies"}),(0,Xt.jsx)(na,{children:"Comprehensive skill set honed through years of product leadership and innovation"})]})]}),(0,Xt.jsxs)(ra,{children:[(0,Xt.jsxs)(aa,{children:[(0,Xt.jsx)(oa,{children:"Technical Skills"}),(0,Xt.jsxs)(sa,{children:[(0,Xt.jsxs)(ca,{children:[(0,Xt.jsx)(ua,{children:"Product Strategy"}),(0,Xt.jsx)(da,{children:n.productManagement.map(((e,t)=>(0,Xt.jsx)(pa,{children:e},t)))})]}),(0,Xt.jsxs)(ca,{children:[(0,Xt.jsx)(ua,{children:"Tools & Technologies"}),(0,Xt.jsx)(da,{children:n.tools.map(((e,t)=>(0,Xt.jsx)(pa,{children:e},t)))})]}),(0,Xt.jsxs)(ca,{children:[(0,Xt.jsx)(ua,{children:"Data & Analytics"}),(0,Xt.jsx)(da,{children:n.data.map(((e,t)=>(0,Xt.jsx)(pa,{children:e},t)))})]})]})]}),(0,Xt.jsxs)(ia,{children:[(0,Xt.jsx)(la,{children:"Core Competencies"}),(0,Xt.jsx)(fa,{children:t.map(((e,t)=>(0,Xt.jsx)(ga,{children:(0,Xt.jsx)(ma,{children:e})},t)))})]})]})]})})})},ya=Yt(tn)`
  background: linear-gradient(180deg, ${Qt.colors.backgroundAlt} 0%, ${Qt.colors.background} 100%);
  padding: ${Qt.spacing.xxl} 0;
`,ba=Yt(rn)`
  max-width: 1200px;
...
`,_a=e=>{let{projects:t}=e;return(0,Xt.jsx)(ya,{id:"projects",children:(0,Xt.jsxs)(ba,{children:[(0,Xt.jsx)(sn,{level:2,size:"title1",gradient:!0,withAccent:!0,children:"Projects"}),(0,Xt.jsx)(va,{children:t.map(((e,t)=>(0,Xt.jsxs)(xa,{children:[(0,Xt.jsx)(wa,{src:e.image,alt:e.title,width:"100%",height:"200px"}),(0,Xt.jsx)(ka,{children:e.title}),(0,Xt.jsx)(Sa,{children:e.description}),(0,Xt.jsx)($a,{children:e.role}),(0,Xt.jsx)(Ca,{children:e.impact}),(0,Xt.jsx)(Ea,{children:e.technologies.map(((e,t)=>(0,Xt.jsx)(za,{children:e},t)))})]},t)))})]})})},Pa=Yt(tn)`
  background: linear-gradient(180deg, ${Qt.colors.background} 0%, ${Qt.colors.backgroundAlt} 100%);
  padding: ${Qt.spacing.xxl} 0;
`,ja=Yt(rn)`
  max-width: 1200px;
...
`,ei=e=>{let{certifications:t}=e;return t&&0!==t.length?(0,Xt.jsx)(Fa,{id:"certifications",children:(0,Xt.jsxs)(Ma,{children:[(0,Xt.jsx)(sn,{level:2,size:"headline",align:"center",marginBottom:"large",children:"Professional Certifications"}),(0,Xt.jsx)(Ba,{children:t.map(((e,t)=>(0,Xt.jsxs)(Ua,{children:[(0,Xt.jsxs)(Wa,{children:[(0,Xt.jsx)(Ha,{image:e.image,children:!e.image&&(0,Xt.jsx)(Va,{issuer:e.issuer})}),(0,Xt.jsxs)(Ya,{children:[(0,Xt.jsx)(Ga,{children:e.name}),(0,Xt.jsx)(Ka,{children:e.issuer})]})]}),(0,Xt.jsxs)(Qa,{children:[e.date," ",e.validUntil?`- ${e.validUntil}`:""]}),e.description&&(0,Xt.jsx)(qa,{children:e.description}),e.skills&&e.skills.length>0&&(0,Xt.jsx)(Xa,{children:e.skills.map(((e,t)=>(0,Xt.jsx)(Ja,{children:e},t)))}),e.credentialUrl&&(0,Xt.jsxs)(Za,{href:e.credentialUrl,target:"_blank",rel:"noopener noreferrer",children:["Verify Credential ",e.credentialId?`#${e.credentialId}`:""]})]},t)))})]})}):null},ti=Kt`
  from {
    opacity: 0;
    transform: translateY(20px);
  }
...
`,oi=Yt.a`
  ...
  animation: ${ti} 0.6s ease forwards;
