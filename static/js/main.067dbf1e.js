...
`,Wa=e=>{let{certifications:t}=e;return t&&0!==t.length?(0,Xt.jsx)(_a,{id:"certifications",children:(0,Xt.jsxs)(Pa,{children:[(0,Xt.jsx)(sn,{level:2,size:"headline",align:"center",marginBottom:"large",children:"Professional Certifications"}),(0,Xt.jsx)(ja,{children:t.map(((e,t)=>(0,Xt.jsxs)(Ta,{children:[(0,Xt.jsxs)(Aa,{children:[(0,Xt.jsx)(Ra,{image:e.image,children:!e.image&&(0,Xt.jsx)(Na,{issuer:e.issuer})}),(0,Xt.jsxs)(La,{children:[(0,Xt.jsx)(Ia,{children:e.name}),(0,Xt.jsx)(Oa,{children:e.issuer})]})]}),(0,Xt.jsxs)(Da,{children:[e.date," ",e.validUntil?`- ${e.validUntil}`:""]}),e.description&&(0,Xt.jsx)(Fa,{children:e.description}),e.skills&&e.skills.length>0&&(0,Xt.jsx)(Ma,{children:e.skills.map(((e,t)=>(0,Xt.jsx)(Ba,{children:e},t)))}),e.credentialUrl&&(0,Xt.jsxs)(Ua,{href:e.credentialUrl,target:"_blank",rel:"noopener noreferrer",children:["Verify Credential ",e.credentialId?`#${e.credentialId}`:""]})]},t)))})]})}):null},Ha=Kt`
  from {
    opacity: 0;
    transform: translateY(20px);
  }
...
`,Qa=Yt.a`
  ...
  animation: ${Ha} 0.6s ease forwards;
